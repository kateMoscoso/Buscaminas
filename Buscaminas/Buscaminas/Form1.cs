    ...
    public partial class Form1 : Form
    {
        ...
        private void refrescarTableroUI(int rows, int cols)
        {
                ...
                for (int j = 0; j < cols; j++)
                {
                    ...
                    else if (contenido.isBomba())
                    {
                       ...
                       flowLayoutPanel1.Enabled = false;
                        DialogResult result;
                        result = MessageBox.Show("Ha perdido la partida, desea salir del juego", "My Application",
            ...
            if (tablero.getNCasillasNoPulsadas() == tablero.getNumeroBombas())
            {
                ...
                result = MessageBox.Show("Ha ganado la partida en "+this.label3.Text+", desea salir del juego", "My Application",
                    MessageBoxButtons.YesNo, MessageBoxIcon.Question);
                if (result == System.Windows.Forms.DialogResult.Yes)
                {
                    this.Close();
